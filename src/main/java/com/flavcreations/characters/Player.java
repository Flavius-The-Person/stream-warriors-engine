...
public class Player
{
	...
	*/
    ...
    public void setData(String pid, int pgen, String pname)
    {
        //health = maxHealth;
        name = pname;
        isKO = false;
        ...
        else if(!inDB)
        {
            ...
            attackIcons[0] = new ImageIcon(//attack 1
                    baseloc + sAttackIcons[pgen] +  "01.png");//attack 1
            attackIcons[1] = new ImageIcon(//attack 2
                    baseloc + sAttackIcons[pgen] + "02.png");//attack 2
            attackIcons[2] = new ImageIcon(//attack 3
                    baseloc + sAttackIcons[pgen] + "03.png");//attack 3
